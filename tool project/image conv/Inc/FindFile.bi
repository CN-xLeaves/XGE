...
Function FindFile(RootDir As String,Filter As String,Attrib As Integer,AttribEx As Find_Rule,Recursive As Integer,BackCall As Function(Path As ZString Ptr,FindData As WIN32_FIND_DATA) As Integer) As Integer
