...
Function CompressBuffer_Lzma(ByVal InBuffer As Any Ptr,ByVal InBufferSize As Integer,ByRef OutBuffer As Any Ptr) As Integer
	...
	Dim LzmaRet As Integer = LzmaCompress(Dst, DstSize, InBuffer, InBufferSize, @Hdr->LzmaProp(0), LZMA_PROPS_SIZE)
