...
Function MainScene(msg As Integer, param As Integer, eve As XGE_EVENT Ptr) As Integer
	...
	Static As xui.Window Ptr frmAbout
	...
	Select Case msg
		...
		Case XGE_MSG_LOADRES			' load resources
			...
			' The Window element has more functions than the Frame element
			' and it is a movable layout that can be dragged
			frmAbout = xui.CreateBaseWindow(160, 120, 320, 240, XUI_LAYOUT_COORD, "About xywh Game Engine")
