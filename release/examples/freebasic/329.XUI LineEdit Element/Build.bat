fbc.exe -s gui "Game.bas" "Game.rc" -x "..\bin\329.XUI LineEdit Element.exe"
@echo;
@echo;
@echo;
@echo     Program compiled to [ ..\bin\329.XUI LineEdit Element.exe ]
@echo;
@echo;
@echo;
