fbc.exe -s gui "Game.bas" "Game.rc" -x "..\bin\325.XUI ScrollBar Element.exe"
@echo;
@echo;
@echo;
@echo     Program compiled to [ ..\bin\325.XUI ScrollBar Element.exe ]
@echo;
@echo;
@echo;
