...
img->PrintText(0, 100, 800, 100, "ËÎÌå", 48, XGE_ALIGN_CENTER Or XGE_ALIGN_MIDDLE Or XGE_FONT_UNDERLINE, &HFFFF00, "xywh Game Engine")
img->PrintText(0, 200, 800, 100, "Î¢ÈíÑÅºÚ", 60, XGE_ALIGN_CENTER Or XGE_ALIGN_MIDDLE Or XGE_FONT_BOLD, &HFFFF, 2, "xywhsoft working group")
img->PrintText(0, 300, 800, 100, "Î¢ÈíÑÅºÚ", 48, XGE_ALIGN_CENTER Or XGE_ALIGN_MIDDLE Or XGE_FONT_BOLD, &HFF00, &HFF, 2, "×÷Õß : xLeaves (Ò¶×ÓµÄÀë¿ª)")
