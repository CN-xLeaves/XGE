fbc.exe -s gui "Game.bas" "Game.rc" -x "..\bin\323.XUI HyperLink Element.exe"
@echo;
@echo;
@echo;
@echo     Program compiled to [ ..\bin\323.XUI HyperLink Element.exe ]
@echo;
@echo;
@echo;
